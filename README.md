...
- 성능 : 문항별 EXPLAIN ANALYZE 전/후(부분 인덱스·재작성) · 조인 3종(NLJ/Hash/Merge) · mv_daily_gmv(15시 갱신 설계)
...
- Q6 재구매율 : 상관 EXISTS → 윈도우 단일 스캔 + 부분 복합 인덱스 — 비용 320,083 → 591 (541배) · 224ms → 1.8ms
